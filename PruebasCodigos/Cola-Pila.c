#include <stdio.h>
#include <stdlib.h>
#define MAX_SIZE 10//TamaÒo maximo de la pila y cola
...
typedef struct {
    ...
    int top;//representa posiciÛn topede la pila en el arreglo items
} Stack;
...
typedef struct {
    ...
    Node* rear;//apunta al ˙ltimo nodo de la cola
} Queue;
...
//implementa la operaciÛn de eliminacion en la pila
int pop(Stack* s) {
